  ...
  <div class="contaner-fluid">
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <p><a href="index.php" class="btn btn-default" type="button"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></p>
      </div>
    </div>
  </div>
               ...
               <div class="panel-collapse">
                  <div class="panel-body">
                     <table class="table table-bordered table-striped">
                        <tr>
                           <th>Resolutions:</th>
                           <td>Load Preset: <select class="form-control" onchange="set_preset(this.value)">
